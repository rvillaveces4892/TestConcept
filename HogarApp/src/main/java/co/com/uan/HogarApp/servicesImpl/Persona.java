...
public abstract class Persona implements IPersona{
    ...
    public List<Usuario> obtenerProveedoresCercanos(String longitud,String latitud,Long servicioId){
        StoredProcedureQuery query=getEm().createStoredProcedureQuery("prc_obtener_proveedores_cercanos").registerStoredProcedureParameter(1,String.class,ParameterMode.IN).registerStoredProcedureParameter(2,String.class,ParameterMode.IN)
                .registerStoredProcedureParameter(3,Long.class,ParameterMode.IN).registerStoredProcedureParameter(4,String.class,ParameterMode.OUT).setParameter(1,longitud).setParameter(2,latitud).setParameter(3,servicioId);
    ...
    public Usuario obtenerUsusarioPorCorreo(String correo){
        ...
        try{
            usuario=em.createNamedQuery("Usuario.findByCorreo",Usuario.class).setParameter("correo",correo.trim()).setParameter("estado","ACTIVO").getSingleResult();
            return usuario;
        }
        catch(NoResultException e){
            return usuario;
