...
import com.entidades.Notificaciones;
...
public class NotificacionesFacadeREST extends AbstractFacade<Notificaciones> {
    ...
    @Path("{id}")
    @Consumes({MediaType.APPLICATION_XML, MediaType.APPLICATION_JSON})
    public void edit(@PathParam("id") BigDecimal id, Notificaciones entity) {
        super.edit(entity);
    }
    ...
    public Notificaciones find(@PathParam("id") BigDecimal id) {
