create or replace PROCEDURE prc_obtener_proveedores_cercanos(longitud IN VARCHAR,latitud IN VARCHAR,id_servicio IN NUMBER ,ids OUT VARCHAR2) AS
P_LATITUD_CLIENTE VARCHAR2(20) := latitud;
P_LONGITUD_CLIENTE VARCHAR2(20) := longitud;
